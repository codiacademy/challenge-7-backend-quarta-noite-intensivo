...
import type { CreateExpenseInput, UpdateExpenseInput } from "../schemas/expenseSchema";
import { createExpenseSchema } from "../schemas/expenseSchema";

export class ExpenseRepository {
  create(data: CreateExpenseInput &{ date: Date }) { 
  ...
  update(id:number, data: Partial<UpdateExpenseInput & { date?:Date }>) {
